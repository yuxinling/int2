...
INSERT INTO SYS_MENU (MENU_ID, MENU_NAME, MENU_URL, PARENT_ID, MENU_ORDER, MENU_ICON, MENU_TYPE) VALUES ('23', '应用设置', '#', '0', '8', 'icon-picture', '2');
INSERT INTO SYS_MENU (MENU_ID, MENU_NAME, MENU_URL, PARENT_ID, MENU_ORDER, MENU_ICON, MENU_TYPE) VALUES ('24', '图片新闻', 'bg/imageNews', '23', '1', NULL, '2');
INSERT INTO SYS_MENU (MENU_ID, MENU_NAME, MENU_URL, PARENT_ID, MENU_ORDER, MENU_ICON, MENU_TYPE) VALUES ('25', '动态新闻', 'bg/articleNews', '23', '2', NULL, '2');
INSERT INTO SYS_MENU (MENU_ID, MENU_NAME, MENU_URL, PARENT_ID, MENU_ORDER, MENU_ICON, MENU_TYPE) VALUES ('26', '商品信息', 'bg/productList', '23', '3', NULL, '2');
INSERT INTO SYS_MENU (MENU_ID, MENU_NAME, MENU_URL, PARENT_ID, MENU_ORDER, MENU_ICON, MENU_TYPE) VALUES ('27', '热门搜索', 'bg/hotKeyList', '23', '4', NULL, '2');
